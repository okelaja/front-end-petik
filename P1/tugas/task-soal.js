 ...
 */
const users = [
  { name: "Diana", age: 25, major: "Computer Science" },
  { name: "Isfa", age: 23, major: "English" },
  { name: "Nurul", age: 21, major: "Business" },
  { name: "Fikri", age: 24, major: "Engineering" },
  { name: "Rina", age: 22, major: "Math" },
];
